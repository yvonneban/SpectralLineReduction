"""
Set of lmtslr exceptions that can be raised
"""
...
class LMTSLRArgumentError(Error):
    """
    Exceptions raised when the argument to a lmtslr
...
class LMTSLRGeneralError(Error):
    """
