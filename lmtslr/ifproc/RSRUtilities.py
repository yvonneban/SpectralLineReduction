...
def m2_model(axis, el):
    """
    Returns the m2 position according to the LMT motion model: z, y, x
    Args:
        axis (int): axis along which to obtain the m2 position
        el (float): elevation
    Returns:
        result (array): m2 position in z, y, x
    """
    #2013:m2 = ((13.08,-24.56,-4.31), (-20.63,2.97,55.73), (1.30, 0, 0))
    #2014:
    #m2 = ((3.67081,-18.79016,1.20343),(52.13792,-42.70486,-8.93449),
    #      (-5.4,0.0,0.0))
    # October 2014
    #m2 = ((4.379755,-20.059959,2.863563),(-47.148803,38.597470,38.988306),
    #      (-5.854850,0.0,0.0))
    # November 2015
#    m2 = ((4.379755,-20.059959,2.863563),(-30.301,28.684,27.677),
#          (-4.1701,0,0,))
    # January 2017
#    m2 = ((14.747,-22.602,-.385),(-14.344,10.631,17.014),(-4.669,0,0,))
    ...
    m2 = ((1.4695, -20.3710, -3.7153), (30.0114, -19.9227, -21.0828), 
          (-3.5177, 0, 0))

    el_r = el * math.pi/180
    result = m2[axis][0] + m2[axis][1] * math.sin(el_r) \
             + m2[axis][2] * math.cos(el_r)
    return result
...
class TempSens():
    ...
    def __init__(self, array):
        """
        Loads array with temperature sensor data, checks it, and 
        calculates special values.
        Args:
            array (array): array with temperature sensor data
        Returns:
            none
        """
        self.tempsens = array
    ...
    def calculate(self):
        """
        Calculates special values from the data array.
        Args:
            none
        Returns:
            none
        ...
        # RTopUpper,RTopLower,LBotUpper,LBotLower,RBotUpper,RBotLower,\
        # LTopUpper,LTopLower
        ...
        # Dish Az: 0,60,120,180,240,300 outer,middle,inner top then \
        # bottom
    ...
    def validate(self):
        """
        Checks the values in the array for validity.
        Args:
            none
        Returns:
            none
    ...
    def process_list(self, thelist):
        ...
        Args:
            thelist (list): list of sensors to calculate average over
        Returns:
            temp (float): average temperature over list of sensors
        """
        temp = 0.0
        count = 0
        for i in thelist:
